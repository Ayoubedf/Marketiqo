...
const Footer = () => {
	return (
		<footer className='border-t border-gray-200/20 dark:border-gray-600/20 bg-gray-50 dark:bg-gray-900'>
			<div className='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
				<div className='md:flex md:justify-between'>
					...
					<div className='grid grid-cols-2 gap-8 text-sm sm:gap-6 sm:grid-cols-3'>
						<div>

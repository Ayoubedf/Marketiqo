...
const categories: Category[] = [
	...
	{ icon: <ShirtIcon className='size-4' />, label: 'Apparel' },
	{ icon: <HomeIcon className='size-4' />, label: 'Home Appliances' },
	{ icon: <ArmchairIcon className='size-4' />, label: 'Furniture' },
			...
			<li>
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button variant='ghost' className='text-muted-foreground bg-gray-50'>
							Categories
						</Button>
					</DropdownMenuTrigger>
					<DropdownMenuContent>
...
const Header = () => {
	...
	useEffect(() => {
		...
		return () => window.removeEventListener('resize', checkNavVisibility);
	}, []);
			...
			<header className='shadow-sm'>
				<div className='container mx-auto'>
					<div className='flex items-center justify-between py-2'>
						<DropdownMenu>
							<DropdownMenuTrigger
								className='size-10 flex items-center justify-center decoration-0 rounded-full mx-2'
								asChild>
								<Button variant='outline'>
									<Avatar>
										<AvatarImage src='https://github.com/shadcn.png' alt='User Avatar' />
										<AvatarFallback>
											<UserCircle2Icon className='text-gray-700 size-full' />
										</AvatarFallback>
									</Avatar>
								</Button>
							</DropdownMenuTrigger>
						...
						<div className='flex-1 mx-1 relative'>
							<div className='absolute inset-0 left-auto flex items-center justify-center text-gray-50 px-3 pointer-events-none'>
						...
						<div className='flex items-center dark:text-white'>
							<Button
								variant='ghost'
								className='md:hidden bg-gray-50 w-12 h-10 mx-2'
					...
					<nav className='hidden md:flex p-2 text-sm justify-between'>
						<Link
							...
							<span className='mr-3'>
								<svg
									...
									<path
										...
										fill='url(#paint0_linear_79_255)'></path>
									<path
										...
										fill='url(#paint1_linear_79_255)'></path>
									<path
										...
										fill='url(#paint2_linear_79_255)'></path>
									<path
										...
										fill='url(#paint3_linear_79_255)'></path>
									<path
										...
										fill='url(#paint4_linear_79_255)'></path>
									<defs>
										<linearGradient
											...
											<stop stopColor='#4AE090'></stop>
											<stop offset='0.99959' stopColor='#4A9DE0'></stop>
											<stop offset='1' stopColor='#4A9DE0'></stop>
										</linearGradient>
										<linearGradient
							...
							<span className='text-base font-semibold whitespace-nowrap'>{APP_NAME}</span>
						</Link>

...
const StoreCard = ({ store }: { store: Store }) => {
	return (
		...
		>
			<figure className="relative h-32 w-full bg-gray-200">
				<Avatar className="absolute bottom-0 left-5 flex size-15 translate-y-1/5 items-center justify-center overflow-hidden rounded-2xl bg-white ring-2 ring-gray-100">
					<AvatarImage
						src={store.logo}
